...
public class Solution {
    ...
    public void testExample() {
        int[] A = { -3, 1, 2, -2, 5, 6 };
        assertEquals(60, new Solution().solution2(A));
    }

    @Test
    public void test3() {
        int[] A = { 1, 2, 3 };
        assertEquals(6, new Solution().solution2(A));
    }

    @Test
    public void test4_1() {
        int[] A = { 1, 2, 3, 4 };
        assertEquals(24, new Solution().solution2(A));
    }

    @Test
    public void test4_2() {
        int[] A = { 1, 2, -3, 4 };
        assertEquals(8, new Solution().solution2(A));
    }

    @Test
    public void test5_1() {
        int[] A = { 1, 2, -3, 4, -10 };
        assertEquals(120, new Solution().solution2(A));
    }
    ...
    public void test10_1() {
        ...
        assertEquals(630, new Solution().solution2(A));
    }

    @Test
    public void test10_2() {
        int[] A = { -10, -8, 1, 2, 3, 4, 5, 6, 7, 8 };
        assertEquals(640, new Solution().solution2(A));
    }
}
